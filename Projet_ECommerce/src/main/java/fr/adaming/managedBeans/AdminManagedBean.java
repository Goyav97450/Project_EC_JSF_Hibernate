...
/**
 * @author Ewen
 * ManagedBean correspondant à la vue Admin
 */
...
public class AdminManagedBean implements Serializable {
	...
	private Admin a;
	/**
	 * Attribut loggedin qui servira conserver le statut de l'admin dans la session et afficher 
	 * une confirmation de connection
	 */
	...
	/**
	 * @param set l'admin du MB pour pouvoir l'enregistrer dans la session
	 */
	...
	/**
	 * @param permet d'enregistrer le statut de l'admin
	 */
	...
	//Autres méthodes correspondant au cas d'utilisation Admin
		/**
		 * Méthode pour vérifier l'existence de l'admin dans la BD et lui permettre de se connecter
		 * @return
		 */
